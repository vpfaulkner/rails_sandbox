...
describe Components::Views::Form, type: :model do
  ...
  describe '#to_partial_path' do
    it 'returns the right path' do
      expect(component.to_partial_path).to eq 'components/views/form'
    end
  end
  ...
  describe '#path' do
    it 'returns the right path' do
      ...
      expect(component.path).to eq('app/views/admin/users/_form.html.erb')
    end
  end
end
